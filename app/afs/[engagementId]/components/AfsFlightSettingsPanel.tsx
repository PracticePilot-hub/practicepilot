...
export default function AfsFlightSettingsPanel({
  engagementId,
  ...
  async function load() {
    try {
      ...
      const response = await fetch(
        `/api/afs/engagements/${engagementId}/opening`,
        {
          cache: "no-store",
  ...
  async function startFlight() {
    try {
      ...
      setMessage(data.workflow?.is_started ? "Settings saved." : "Flight started.");
      onChanged?.();
    } catch (error: any) {
  ...
  if (loading) {
    return <section style={styles.shell}>Loading flight settings...</section>;
  }
  ...
  return (
    <section style={styles.shell}>
      <div style={styles.settingsHeader}>
        <div>
          <strong style={styles.settingsTitle}>Flight Settings</strong>
          <span style={styles.settingsHelp}>
            Workflow and crew for this AFS file.
          </span>
        </div>

        <span style={styles.stateBadge}>
          {workflow?.is_started ? "Started" : "Not started"}
        </span>
      </div>

      <div style={styles.row}>
        <div style={styles.labelBlock}>
          <span style={styles.kicker}>WORKFLOW</span>
