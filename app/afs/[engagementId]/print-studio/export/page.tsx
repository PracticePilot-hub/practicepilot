...
.afsDraftWatermark {
  ...
  white-space: nowrap;
        ...
        /* V11: darker, print-safe hierarchy without returning to marker-bold. */
        .afsExportOnlyRoot,
        .afsExportOnlyRoot * {
        ...
        /* Running header must read clearly but stay secondary. */
        .afsExportOnlyRoot [id^="print-"]:not(#print-cover-page) article > div:first-child * {
          color: #000 !important;
        ...
        /* Directors report */
        #print-directors-report h3,
        #print-directors-report h4 {
          color: #000 !important;
          font-weight: 600 !important;
        }
        ...
        /* Prevent continuation heading and the first note from colliding. */
        .afs-export-notes-page + .afs-export-notes-page {
          padding-top: 0 !important;
        }


        #print-compiler-report .afs-compiler-signature-repeat {
