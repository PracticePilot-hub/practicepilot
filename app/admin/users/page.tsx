...
async function loadSecurePage() {
  ...
  if (
    !profileData.access_enabled ||
    !isAdminRoleValueSecure(profileData.role) ||
    profileData.organisation_id !== null
  ) {
    alert("You do not have access to PracticePilot Team.");
  ...
  async function handleCreateUser() {
    ...
    const response = await fetch("/api/users", {
      ...
      body: JSON.stringify({
        ...
        canAccessAssets: modules.assets,
    ...
    <main style={styles.page}>
      <div style={styles.header}>
        <div>
          ...
          <p style={styles.subtitle}>Manage PracticePilot internal users, roles and module access.</p>
        </div>
      ...
      <section style={styles.card}>
        <h2 style={styles.cardTitle}>Add PracticePilot User</h2>
          ...
          <div style={styles.checkboxGroup}>
            <label style={styles.checkboxLabel}>
              <input
                ...
                disabled={!modules.projects || isAdminRole}
              />
              Can edit projects
            </label>
          </div>
      ...
      <section style={styles.card}>
        <h2 style={styles.cardTitle}>PracticePilot Internal Users</h2>
